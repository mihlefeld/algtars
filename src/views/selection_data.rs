...
pub fn get_selection_data(trainer: &str) -> Option<SelectionDataJson> {
    match trainer {
        "2x2-EG" => Some(SelectionDataJson {
            ...
            _scrambles: include_str!("../../assets/2x2/EG/scrambles.json").to_string(),
        }),
        "2x2-FH" => Some(SelectionDataJson {
            ...
            _scrambles: include_str!("../../assets/2x2/FH/scrambles.json").to_string(),
        }),
        "2x2-LS" => Some(SelectionDataJson {
            ...
            _scrambles: include_str!("../../assets/2x2/LS/scrambles.json").to_string(),
        }),
        "2x2-TCLL" => Some(SelectionDataJson {
            ...
            _scrambles: include_str!("../../assets/2x2/TCLL/scrambles.json").to_string(),
        }),
        "2x2-TEG" => Some(SelectionDataJson {
            ...
            _scrambles: include_str!("../../assets/2x2/TEG/scrambles.json").to_string(),
        }),
        "3x3-CMLL" => Some(SelectionDataJson {
            ...
            _scrambles: include_str!("../../assets/3x3/CMLL/scrambles.json").to_string(),
        }),
        "3x3-OH-CMLL" => Some(SelectionDataJson {
            ...
            _scrambles: include_str!("../../assets/3x3/OH-CMLL/scrambles.json").to_string(),
        }),
        "3x3-OH-PLL" => Some(SelectionDataJson {
            ...
            _scrambles: include_str!("../../assets/3x3/OH-PLL/scrambles.json").to_string(),
        }),
        "3x3-OH-ZBLL" => Some(SelectionDataJson {
            ...
            _scrambles: include_str!("../../assets/3x3/OH-ZBLL/scrambles.json").to_string(),
        }),
        "3x3-OLL" => Some(SelectionDataJson {
            ...
            _scrambles: include_str!("../../assets/3x3/OLL/scrambles.json").to_string(),
        }),
        "3x3-PLL" => Some(SelectionDataJson {
            ...
            _scrambles: include_str!("../../assets/3x3/PLL/scrambles.json").to_string(),
        }),
        "3x3-ZBLL" => Some(SelectionDataJson {
            ...
            _scrambles: include_str!("../../assets/3x3/ZBLL/scrambles.json").to_string(),
        }),
        "Megaminx-PLL" => Some(SelectionDataJson {
            ...
            _scrambles: include_str!("../../assets/Megaminx/PLL/scrambles.json").to_string(),
        }),
        "Megaminx-OLL" => Some(SelectionDataJson {
            ...
            _scrambles: include_str!("../../assets/Megaminx/OLL/scrambles.json").to_string(),
        }),
        "Octaminx-L3T" => Some(SelectionDataJson {
            ...
            _scrambles: include_str!("../../assets/Octaminx/L3T/scrambles.json").to_string(),
        }),
        "Octaminx-TCP" => Some(SelectionDataJson {
            ...
            _scrambles: include_str!("../../assets/Octaminx/TCP/scrambles.json").to_string(),
        }),
        "Pyraminx-L4E" => Some(SelectionDataJson {
            ...
            _scrambles: include_str!("../../assets/Pyraminx/L4E/scrambles.json").to_string(),
        }),
        "Skewb-NS2" => Some(SelectionDataJson {
            ...
            _scrambles: include_str!("../../assets/Skewb/NS2/scrambles.json").to_string(),
        }),
        _ => None,
    }
}